  ...
  const achievements = [
    {
      ...
      description: "Recognized for exceptional leadership in Business Society",
      date: "March 2024",
      icon: Trophy
    },
    {
      title: "Community Builder",
      description: "Helped grow International Students Society membership by 40%",
      date: "February 2024",
      icon: Users
    },
    {
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <p className="text-white/80">Student ID: {studentInfo.studentId}</p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <Input value={studentInfo.email} className="mt-1" />
                    ) : (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <Input value={studentInfo.phone} className="mt-1" />
                    ) : (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <Input value={studentInfo.location} className="mt-1" />
                    ) : (
                      <p className="font-medium">{studentInfo.location}</p>
                    )}
                  </div>
                </div>
